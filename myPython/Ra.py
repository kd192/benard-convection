...
case_dir = "/home/kodai/RBConvection"

# Specify characteristic length
L = 0.005  # Characteristic length

# Specify gravity acceleration
g = 9.81  # m/s^2

# Specify the thermal expansion coefficient
beta = 0.000214  # See "/constant/transportProperties"
...
nu = 0.000001 * rhoRef  # See "/constant/transportProperties"
